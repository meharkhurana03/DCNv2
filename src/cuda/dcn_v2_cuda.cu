                    ...
                    const int deformable_group)
{
    ...
    // changes borrowed from https://github.com/lucasjinreal/DCNv2_latest/commit/a4b9f09a8aa0f5f9991d71bb3d26c45fa45e3558
                                             ...
                                             int deformable_group)
{
    ...
    for (int b = 0; b < batch; b++)
    {
        ...
        // TODO: Old code uses ones, new code uses columns
        // THCudaBlas_Sgemm(state,
        //     'N', 'N', 1, m_, k_, 1.0f,
